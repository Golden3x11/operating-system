...
public class CSCAN_fd_scan {
    ...
    public static String compute(ArrayList<ProcessDisc> listO, int current, int end) {
        ...
        return "CSCAN FD SCAN: "+"droga "+ wayOfArm+" czas "+time;
    }
    ...
    public static SCAN_fd_scan.FDSCANComparator getFDSCANComparator(){
        return new SCAN_fd_scan.FDSCANComparator();
    }
